...
import { Check, Plus, MoreHorizontal, Play, Pause, RotateCcw, X } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-sm border-2 border-gray-200">
            ...
            <div className="text-center mt-6 p-4 bg-orange-50 rounded-xl">
              <div className="text-2xl font-bold text-orange-600">{completedPomodoros}</div>
                  ...
                  {task.subtasks.length > 0 && (
                    <div className="ml-9 space-y-2">
                      {task.subtasks.map((subtask) => (
                        <div key={subtask.id} className="flex items-center gap-3 p-2 bg-gray-50 rounded-lg border border-gray-200 group">
                          {/* 子任務完成狀態勾選框 */}
                          <button
